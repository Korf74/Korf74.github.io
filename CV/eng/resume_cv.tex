...
\makecvfooter{\today}{Rémi Coudert~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
...
Looking for hybrid opportunities in \{Lausanne, Geneva, Thonon\} area or Full Remote in France and EMEA
