...
\mobile{(+33) 6 42 99 76 62}

\email{remi-coudert@protonmail.com}
\homepage{korf74.github.io/}
\github{Korf74}
%\linkedin{posquit0}
%\skype{skypeid}
%\stackoverflow{SOid}{SOname}
%\twitter{@twit}
\linkedin{rémi-coudert-b9b176150}
%\reddit{reddit account}
%\xing{xing name}
%extrainfo{https://scholar.google.com/citations?user=Kc0rEZEAAAAJ&hl=en&oi=ao} % Other text you want to include on this line

\position{Software Engineer / Ingénieur Informatique} % Your expertise/fields
%\quote{``Make the change that you want to see in the %world."} % A quote or statement

\makecvfooter{\today}{Rémi Coudert~~~·~~~CV}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
...
A la recherche d'opportunités autour de \{Lausanne, Genève, Thonon\} ou en TT complet en France/EU
